...
LIMIT_REPLIES = [
    "Ляляля, вы исчерпали лимит. Сообщение не отправлено.",
    "Ту-ту-ту, сообщения закончились! Сообщение не отправлено.",
    "Вот так! Вы достигли предела. Сообщение не отправлено.",
    "Пиип-пиип, лимит превышен! Сообщение не отправлено.",
    "Ой-ой, больше нельзя писать. Сообщение не отправлено.",
    "Молчу! Вы исчерпали все сообщения. Сообщение не отправлено.",
    "Хватит-хватит! Лимит закончился. Сообщение не отправлено.",
    "Бип-боп, лимит активирован! Сообщение не отправлено.",
    "Ники-ники-ни, нельзя больше писать. Сообщение не отправлено.",
    "Уй-уй-уй, вы переборщили! Сообщение не отправлено.",
    "Ликбез готов: лимит исчерпан. Сообщение не отправлено.",
    "Киви-киви, больше нет мест! Сообщение не отправлено.",
    "Отказано! Лимит достигнут. Сообщение не отправлено.",
    "Луна-луна, вы перешли границу. Сообщение не отправлено.",
    "Яй-яй-яй, конец истории! Сообщение не отправлено."
]
